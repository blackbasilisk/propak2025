...
async function saveLeadInfo(lead) {
  ...
  try {
    ...
    await pool.request()
      ...
      .query('INSERT INTO Lead (FirstName, LastName, Company, Email, Phone, UserId, BOD, HR, SC, Eidos, DS, CL, ColorJet) VALUES (@firstName, @lastName, @company, @email, @phone, @userId, @isPrintBOD, @isPrintHR, @isPrintSC, @isPrintEidos, @isPrintDS, @isPrintCL, @isPrintColorJet)');      
      //.query('INSERT INTO Lead (FirstName, LastName, Company, Email, Phone, QRCode) VALUES (@firstName, @lastName, @company, @email, @phone, @scan)');
